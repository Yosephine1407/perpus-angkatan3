...
if (isset($_POST['tambah'])) {
    ...
    $insert = mysqli_query($connection, "INSERT INTO user 
...
$editUser = mysqli_query($connection, "SELECT * FROM user WHERE id = '$id'");
...
if (isset($_POST['edit'])) {
    ...
    $update = mysqli_query($connection, "UPDATE user SET nama='$nama',email='$email',password='$password',jenis_kelamin='$jenis_kelamin',telepon='$telepon' WHERE id= '$id'");
                ...
                <form action="" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text"
                            class="form-control"
                            name="nama"
                            placeholder="Masukkan nama anda" value="<?php echo isset($_GET['edit']) ? $rowEdit['nama'] : '' ?>">
                    </div>
                    <div class="mb-3">
